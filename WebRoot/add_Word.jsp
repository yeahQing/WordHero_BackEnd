  		...
  		<div class="content">
  			<div class="list_part">
  				<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
					  <tr>
					   	 <td align="center" class="list_title" height="60">添加单词</td>
					  </tr>
				</table>
  				 <form action="/Word_Hero/Word?action=addWord" method="post">
	  				 <div class="info_style">
	  				 	 <div class="input-group">
	                        <i class="icon icon-word"></i>
	                       	<label class="input_label">单词名:</label><input type="text" placeholder="请输入单词名" id="word_name" name="word_name">
	                    </div>
	                    <div class="input-group">
	                        <i class=" icon icon-translate"></i>
	                       	<label class="input_label">翻译:</label><input type="text" placeholder="请输入翻译" id="word_translate" name="word_translate">
	                    </div>
	  				 </div>
